export default  [
    {
        ...
        Your_baby: "Your pregnancy is calculated according to the first day of your last period. In the first week of your menstrual cycle, and in the second week your ovaries release an egg (called an ovum). This is fertilised by your partner’s sperm sometime in the third week. About 30 hours after conception, the fertilised egg divides into two. At this stage it is called a zygote. The cells keep dividing and multiplying in numbers and the zygote gradually moves down the fallopian tube towards the womb (uterus).By the end of the fourth week, the egg implants itself into your uterus. It is now called a blastocyst. It is about 0.2mm wide and contains about 200 cells.The blastocyst is made up of different layers of cells. The outer layer, called the ectoderm, will become the baby’s nervous system and brain. The middle layer, or mesoderm, will become the heart, blood vessels, muscles, and bones, and the inner layer, or endoderm will become the breathing and digestive systems. The outside of the blastocyst has small tentacles called chorionic villi, which will develop into the placenta.",
        Length: "0.2mm",

        Weight: "cann’t measure",

        Your_Body: "As soon as you conceive, the hormone levels in your body start to change. You produce more of the hormone progesterone, which prevents you from having a period, and there is an increase your levels of human chorionic gonadotropin (hCG). This is the pregnancy hormone that is detected when you do a pregnancy test.You probably won’t notice any signs that you’re pregnant just yet. The first sign for many women is that they miss their period at the end of week 4.Things_to_remember:Your baby will have the best possible start in life if you make sure you are healthy when you conceive.If you are trying for a baby, it’s a good idea to take 400 micrograms of folate every day to prevent neural tube defects such as spina bifida. If the baby is planned, you might consider seeing your doctor to talk about genetic screening or to be tested for any sexually transmitted infections before you fall pregnant.You should try to eat a healthy diet and make sure you’re not overweight when you’re trying to fall pregnant. Not drinking alcohol and giving up smoking are best for your baby.Read more here about preconception health.",
    ...
    {
        Week: 5,
        Your_baby: "By week 5, your baby has burrowed into the wall of your uterus. It is now called an embryo and measures about 2mm from end to end. The foundations for all of the major organs are in place. The baby is inside an amniotic sac, a bag of fluid that protects it.The cells in the baby are still dividing. In week 5, the brain and spinal column are already starting to form. The spinal cord is called the neural tube and is developing as an open groove. Your baby’s head is much larger than the rest of the body at this stage as the brain and face are developing very rapidly.Your baby’s heart will start beating this week. The blood vessels are already starting to form and blood is circulating in the baby’s body. A string of blood vessels connects you to your baby, and this will eventually become the umbilical cord.",

        Length: "2mm",
        Weight: "cann’t measure",

        Your_Body: "Week 5 is when most women start to wonder whether they may be pregnant. You will have missed your period, but you may be feeling like it’s just about to start. You may notice your breasts are larger and feel sore, and you may be feeling quite tired.Some women may feel nauseous, or notice they need to go to the toilet more often than usual.You will also be producing more human chorionic gonadotropin (hCG)",

        Things_to_remember : "You can do a pregnancy test the day after you miss your period. There are many different tests available, so make sure you follow the instructions carefully. If the pregnancy test shows you’re pregnant, it’s a good idea to see your doctor as soon as possible. They will confirm you are pregnant and advise you on how to look after yourself and your baby.Finding out you’re pregnant can be very exciting. But for some women, pregnancy is unplanned. Whether the baby was planned or not, you may feel a range of emotions from joy to surprise to shockIt’s important not to drink any alcohol, smoke cigarettes or take illicit drugs if you’re pregnant since these can all be very harmful for your baby.",
...
export const english_p_data = [
    ...
    {
        Week: 40,
        Your_baby: "You have now reached your due date! Your baby is likely measuring about    50cm and weighing about 3.5 kg. Their head circumference is about 35cm.A well grown, term baby can weigh anything from 2.9kg to 4.2kg – all pregnancies are different. If you have a large baby or small baby, in some instances you may require more monitoring. Your doctor or midwife will discuss any concerns they may have with you, making sure to provide individualised care that is right for you and your baby.Your baby’s movements are very important right until the end of your pregnancy and even into labour. If your baby’s movement pattern changes, it may be a sign that they are unwell. If you are concerned at any stage about a change in your babies’ movements, contact your doctor or midwife immediately.",
