...
export const ICONS: ThemeIcons = {
  ...
  earbuds: require('../assets/icons/images/earbuds.png'),
    gallery: require('../assets/icons/images/gallery.png'),
    pause: require('../assets/icons/images/pause.png'),
    play: require('../assets/icons/images/play.png'),
    stop: require('../assets/icons/images/stop.png'),
    ...
    bookmark: require('../assets/icons/images/bookmark.png'),
    save_instagram: require('../assets/icons/images/save-instagram.png'),
