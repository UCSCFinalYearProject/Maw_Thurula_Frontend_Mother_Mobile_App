    ...
    return (
        <Block>
            ...
            >
                <Block color={colors.card} row flex={0} padding={sizes.padding} >
                    <Block
                        ...
                        <Block
                            ...
                            {
                                baby_tracker.map((item:any, index:any) => {
                ...
                {
                    baby_tracker[activeWeek - 1].topics ? baby_tracker[activeWeek - 1].topics.map((item: any, index: number) => {
                        return (
                            <Block
                            ...
                            >
                                <Block
                                    flex={0} >
                                    <Text size={16} bold marginBottom={10} > {item.title} </Text>
                                </Block>
                                <Block
                                    card
                                    flex={0} >
