...
const Switch = ({ id = 'Switch', checked = false, thumbColor = 'white', activeFillColor, inactiveFillColor, duration = 250, thumbStyle, switchStyle, style, onPress, haptic = true, ...props }) => {
    ...
    return (React.createElement(Pressable, { ...switchID, hitSlop: sizes.s, onPress: handleToggle, style: containerStyles, ...props },
        React.createElement(Animated.View, { style: switchStyles },
            React.createElement(Animated.View, { style: thumbStyles }))));
};
